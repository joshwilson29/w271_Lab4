...
Since furthermore none of our explanatory variables are constant over time and we have reason to believe that it is very likely that the explanatory variables are correlated with the unobserved/fixed effect state, we believe that the Fixed Effects Model is the better model for our scenario.
